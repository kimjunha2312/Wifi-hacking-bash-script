...
print('''
\033[1;92mRecoded By Monayem Hossain 
Devil King 
...
Advanced arguments:
    ...
    --vuln-list=<filename>   : Use custom file with vulnerable devices list ['vulnewdv.txt']
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--vuln-list',
        type=str,
        default=os.path.dirname(os.path.realpath(__file__)) + '/vulnewdv.txt',
